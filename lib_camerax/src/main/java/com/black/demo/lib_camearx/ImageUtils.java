...
public class ImageUtils {
    ...
    public static void init(@NotNull Application applicationContext) {
        ImageUtils.applicationContext = applicationContext;
    }

    private static Application getApp() {
        if (applicationContext == null) {
            throw new NullPointerException("ImageUtils not init");
        }
    ...
    private static Bitmap fastBlur(final Bitmap src,
                                  @FloatRange(
                                          from = 0, to = 1, fromInclusive = false
                                  ) final float scale,
                                  @FloatRange(
    ...
    private static Bitmap stackBlur(final Bitmap src, int radius, final boolean recycle) {
    ...
    private static Bitmap renderScriptBlur(final Bitmap src,
                                          @FloatRange(
                                                  from = 0, to = 25, fromInclusive = false
                                          ) final float radius,
                                          final boolean recycle) {
